...
class VM:
    ...
    def __init__(self, name, cores, memory, lifetime, profile=None, maxcpu=[], avgcpu=[], mincpu=[], pred_lifetime=0, start_time=0, priority=0):
    # def __init__(self, name, cores, memory, lifetime, cpuusage=[], pred_lifetime=0, start_time=0, priority=0):
        ...
        retval = [self.name, self.cores, self.memory, self.lifetime, self.profile]
