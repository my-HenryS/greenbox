...
if __name__ == "__main__":
    ...
    name = f'site{N_SITES}_slo{sys.argv[2]}_powermis{sys.argv[3]}_lifemis{sys.argv[4]}_dist{sys.argv[5]}_start{sys.argv[6]}_lookahead{sys.argv[7]}_UTIL{sys.argv[8]}_distr'
    ...
    # scheduling_policies = ["mip-app"]
    #scheduling_policies = ["greedy"]
    
    # batch_name = "site_subgraph_identification"
    # site_policies = ["random", "avg_cov"]
    # subgraph_policies =  ['geo', 'cov'] 
    # placement_policies = ["greedy"]
    # policies = [("random", "geo"), ("avg_cov", "cov")]
    # # scheduling_policies = ["mip"]
    # # scheduling_policies = ["greedy"]
    # scheduling_policies = ["mip"]
    
    # batch_name = "site_identification_one_week_new"
    # site_policies = ["random", "avg_cov", "avg_min"]
    # subgraph_policies =  ["geo"]
    # placement_policies = ["greedy"]
    # scheduling_policies = ["mip"]
    # policies =  list(itertools.product(site_policies, subgraph_policies))
    
    # batch_name = "subgraph_identification_one_week"
    # site_policies = ["random", "avg_cov"]
    # subgraph_policies = ["cov", "geo", "stable"]
    # placement_policies = ["greedy"]
    # scheduling_policies = ["greedy"]
    # policies =  list(itertools.product(["avg_cov"], subgraph_policies))
