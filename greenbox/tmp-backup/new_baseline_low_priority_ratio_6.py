...
greenbox = []
expt = "week2"
with open(f"data/new_baseline_low_priority_ratio_6_{expt}.dat", "r") as f:
# with open("data/new_baseline_low_priority_ratio_6_total.dat", "r") as f:
...
plt.tight_layout()
plt.savefig(f"figure/new_baseline_low_priority_ratio_bar_6_{expt}.png")
plt.savefig(f"figure/new_baseline_low_priority_ratio_bar_6_{expt}.pdf")
plt.clf()
