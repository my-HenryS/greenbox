...
normal(){
    ...
    do
        ...
        do
            ...
            do
                python3 simulator.py $1 $i 0 0 $j $k &> tmp/raw/realdist_azurev1_site$1_slo${i}_lifetimemis0_powermis0_dist${j}_starttime${k}_centralized_persubgraph.txt &
            done
        done

        python3 simulator.py $1 100 0 0 0 $k &> tmp/raw/realdist_azurev1_site$1_slo100_lifetimemis0_powermis0_dist0_startime${k}_centralized_persubgraph.txt &
    done
}
...
scale(){
    ...
    do
        ...
        do
            for j in 10
            do
                # python3 simulator.py $1 $i 0 0 $j $k 4 &> tmp/raw/realdist_azurev1_site$1_slo${i}_lifetimemis0_powermis0_dist${j}_starttime${k}_centralized_persubgraph.txt &
